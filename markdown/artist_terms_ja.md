...
## 第 5 条の 2（決済サービスの利用規約の遵守）

1. 本サービスの決済サービスには、[PAY.JP](https://pay.jp/)を利用するものとします。
2. アーティストは、[決済サービスの加盟店利用規約](https://pay.jp/terms/20241001/tos-marketplace-tenant.pdf)を遵守しなければなりません。
